					...
					<div class="col-md-4 col-lg-5">
						<div class="row">
							<div class="col-md-12 col-lg-8 mb-md-0 mb-4">
								<h2 class="footer-heading"><a href="#" class="logo" ><img  src="./IMG/Logo-removebg-preview.png" alt=""></a></h2>
								<p></p>
								<a href="#"> <span class="ion-ios-arrow-round-forward"></span></a>
							</div>
						</div>
				...
				<div class="row partner-wrap mt-5">
					<div class="col-md-12">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="mb-0">Nuestros Clientes:</h3>
							</div>
              
							<div class="col-md-9">
								<p class="partner-name mb-0">
							
									<a href="#"><span class="ion-logo-ionic mr-2"></span><img src="./IMG/logodes2.png" alt=""></a>
									
								</p>
							</div>
							<div class="col text-md-right">
								<p class="mb-0"><a href="#" class="btn-custom">Saber Más <span class="ion-ios-arrow-round-forward"></span></a></p>
							</div>
						</div>
					</div>
				</div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
          ...
          <div class="col-md-6 col-lg-4 text-md-right">
          	<p class="mb-0 list-unstyled">
          		<a class="mr-md-3" href="#"><img src="./IMG/facebook (2).png" width="50px" alt=""></a>
          		<a class="mr-md-3" href="#"><img src="/IMG/gorjeo.png" alt=""></a>
